package com.coreservlets.events1example;
...
public class Events1Example extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.main); // Must call setContentView before findViewById
    ...
    /** Sets the color of the color region. Color region is a View
